          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  { label: 'GITHUB', url: 'https://github.com/Kishorekumarps07' },
                  { label: 'LINKEDIN', url: 'https://www.linkedin.com/in/kishorekumarps' },
                  { label: 'LEETCODE', url: 'https://leetcode.com/u/kishore_kumar_p_s/' },
                  { label: 'INSTAGRAM', url: 'https://www.instagram.com/_kisshhhh_/' }
                ].map((item) => (
                  <a
                    key={item.label}
                    href={item.url}
            ...
            <div className="lg:col-span-4 flex flex-col items-end gap-6 text-right">
              <div className="p-8 border border-white/5 bg-white/5 backdrop-blur-md relative group">
                ...
                <motion.a
                  href="mailto:kishore3kumar4@gmail.com"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="mt-8 block text-center w-full bg-white text-black font-bebas text-2xl py-3 border-2 border-black hover:bg-red-600 hover:text-white transition-all shadow-[8px_8px_0px_#E23636] hover:shadow-none"
                >
                  SWING TO INBOX
                </motion.a>
              </div>
