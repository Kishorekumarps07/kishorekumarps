...
import { Briefcase, ChevronRight, Globe } from 'lucide-react';
              ...
              >
                ...
                <div className="bg-[#0A0A0A] border border-white/5 p-10 hover:border-red-600/30 transition-all duration-500 relative overflow-hidden group/card">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-10">
                    <div>
                      <h3 className="font-bebas text-5xl text-white tracking-tight mb-2 group-hover/card:text-red-500 transition-colors">
                        {exp.role}
                        {exp.liveLink && (
                          <a href={exp.liveLink} target="_blank" rel="noreferrer" className="inline-block ml-4 text-white/40 hover:text-red-500 transition-colors" title="View Live Project">
                            <Globe size={28} className="inline mb-1" />
                          </a>
                        )}
                      </h3>
